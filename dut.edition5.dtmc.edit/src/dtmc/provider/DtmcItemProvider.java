...
/**
 * This is the item provider adapter for a {@link dtmc.Dtmc} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class DtmcItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dtmc_ModuleName_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dtmc_ModuleName_feature", "_UI_Dtmc_type"),
				 DtmcPackage.Literals.DTMC__MODULE_NAME,
				 true,
				 false,
				 false,
	...
	protected void addStateVariablePropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Dtmc_StateVariable_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Dtmc_StateVariable_feature", "_UI_Dtmc_type"),
				 DtmcPackage.Literals.DTMC__STATE_VARIABLE,
				 true,
				 false,
				 false,
				 ItemPropertyDescriptor.GENERIC_VALUE_IMAGE,
	...
	public String getText(Object object) {
		String label = ((Dtmc)object).getModuleName();
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(DtmcPackage.Literals.DTMC__TRANSITIONS,
				 DtmcFactory.eINSTANCE.createTransition()));

		newChildDescriptors.add
			(createChildParameter
				(DtmcPackage.Literals.DTMC__REWARDS,
				 DtmcFactory.eINSTANCE.createReward()));
	}
